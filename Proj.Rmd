...
start=Sys.time()
algorithm = finish_times(arrivals = as.numeric(dffd$ArrivalTime)-1501563500, service = dffd$ServerTime*3600, due = as.numeric(dffd$DueTime)-1501563500, servers = 25)
Sys.time()-start
...
mean(dffd$OnTime[seq(1,10000)])
mean(dffd$BeforeLastHour[seq(1,10000)])
mean(dffd$BeforeLast4Hour[seq(1,10000)])
